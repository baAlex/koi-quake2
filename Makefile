# ----------------------------------------------------- #
# Makefile for the q2me game module for Quake II        #
#                                                       #
...
Q2ME_OBJS = $(patsubst %,build/%,$(Q2ME_OBJS_))

# ----------

# Generate header dependencies
Q2ME_DEPS= $(Q2ME_OBJS:.o=.d)
...
ifeq ($(YQ2_OSTYPE), Windows)
release/game.dll : $(Q2ME_OBJS)
	@echo "===> LD $@"
	${Q}$(CC) -o $@ $(Q2ME_OBJS) $(LDFLAGS)
else ifeq ($(YQ2_OSTYPE), Darwin)
release/game.dylib : $(Q2ME_OBJS)
	@echo "===> LD $@"
	${Q}$(CC) -o $@ $(Q2ME_OBJS) $(LDFLAGS)
else
release/game.so : $(Q2ME_OBJS)
	@echo "===> LD $@"
	${Q}$(CC) -o $@ $(Q2ME_OBJS) $(LDFLAGS)
endif
